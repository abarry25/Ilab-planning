...
function syncRowHeights() {
  ...
  const wh = document.getElementById("weekHeaderRow");
  const spacer = document.getElementById("namesSpacer");
  if (ms && wh && spacer) {
    spacer.style.height = (ms.offsetHeight + wh.offsetHeight) + "px";
  }
}
